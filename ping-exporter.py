...
def ping(host, prot, interval, count, size, source):
    ...
    if source == '':
        ...
        ping_command = '{} -{} -b {} -i 1 -p {} -q -c {} -S {} {}'.format(filepath, prot, size, interval, count, source,
                                                                          host)
    ...
    # Execute the ping
    cmd_output = subprocess.Popen(ping_command, stdout=subprocess.PIPE, stderr=subprocess.PIPE,
